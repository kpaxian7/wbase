package com.bnb.wbasemodule.widget.scrollable;
...
public class ScrollableHelper {
    ...
    public boolean isTop() {
        ...
        if (scrollableView instanceof ScrollableLayout) {
            return isScrollLayoutTop((ScrollableLayout) scrollableView);
        }
    ...
    private static boolean isScrollLayoutTop(ScrollableLayout scrollableLayout) {
        if (scrollableLayout != null) {
            int scrollViewY = scrollableLayout.getScrollY();
            return scrollViewY <= 0;
        }
        return false;
    }
